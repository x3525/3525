...
Tam olarak 1 derinlik için *1 ifadesini kullan:
...
Minimum derinlik 1 ve maksimum derinlik 2 için *1..2 ifadesini kullan:
...
Sınırsız derinlik için *1.. ifadesini kullan:
